...
public class OPStorageOPTest {
    ...
    public void testToString() {
        ...
        assertEquals("9.876numprefix.draconicevolution.10-12", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.876numprefix.draconicevolution.10-15", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-18", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-21", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-24", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-27", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-30", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-33", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-36", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
        ...
        assertEquals("9.999numprefix.draconicevolution.10-39", storageOP.getReadable());
//        LOGGER.info(storageOP.getScientific());
