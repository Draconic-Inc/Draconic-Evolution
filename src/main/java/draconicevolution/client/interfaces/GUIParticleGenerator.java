...
public class GUIParticleGenerator extends GuiScreen
{
	...
	public void initGui()
	{
		...
		if (page < 3)
			buttonList.add(new GuiButton(54, posX - 21, posY + 3, 20, 20, "i"));
		else
			buttonList.add(new GuiButton(55, posX - 31, posY + 23, 30, 20, "Back"));
