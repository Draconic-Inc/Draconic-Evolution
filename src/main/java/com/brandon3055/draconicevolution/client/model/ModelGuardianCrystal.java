 ...
 */
public class ModelGuardianCrystal extends ModelBase {
    ...
    public void render(Entity entity, float f1, float f2, float f3, float deathAnimation, float health, float scale) {
        ...
        GlStateManager.translate(0.0F, 0.1F + deathAnimation * 0.9F, 0.0F);
        GlStateManager.rotate(f2 * 2, 0.0F, 1.0F, 0.1F);
        GlStateManager.scale(s, s, s);
        this.ringBase1.render(scale);
        GlStateManager.popMatrix();

        GlStateManager.rotate(f2, 0.0F, 1.0F, 0.0F);
        GlStateManager.translate(0.0F, 0.7F + deathAnimation * (0.1F + f3), 0.0F);
