 ...
 */
public abstract class VBOBipedModel<T extends LivingEntity> extends HumanoidModel<T> {
...
//    }
    ...
    @Override
    public void renderToBuffer(PoseStack mStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {}

    public abstract void render(PoseStack mStack, MultiBufferSource getter, T entity, ItemStack itemstack, int packedLight, int packedOverlay, float red, float green, float blue, float alpha);
...
//            this.bipedLeftArm.yRot = Mth.lerp(f5 / f4, 0.4F, 0.85F);
//            this.bipedLeftArm.xRot = Mth.lerp(f5 / f4, this.bipedLeftArm.xRot, (-(float)Math.PI / 2F));
...
//            this.bipedRightArm.yRot = Mth.lerp(f6 / f4, -0.4F, -0.85F);
//            this.bipedRightArm.xRot = Mth.lerp(f6 / f4, this.bipedRightArm.xRot, (-(float)Math.PI / 2F));
//        }
//
...
//                this.bipedRightArm.xRot = Mth.lerp(f8, this.bipedRightArm.xRot, 0.0F);
//                this.bipedLeftArm.yRot = this.rotlerpRad(this.bipedLeftArm.yRot, (float)Math.PI, this.swimAmount);
//                this.bipedRightArm.yRot = Mth.lerp(f8, this.bipedRightArm.yRot, (float)Math.PI);
...
//                this.bipedRightArm.zRot = Mth.lerp(f8, this.bipedRightArm.zRot, (float)Math.PI - 1.8707964F * this.getArmAngleSq(f7) / this.getArmAngleSq(14.0F));
...
//                this.bipedRightArm.xRot = Mth.lerp(f8, this.bipedRightArm.xRot, ((float)Math.PI / 2F) * f10);
//                this.bipedLeftArm.yRot = this.rotlerpRad(this.bipedLeftArm.yRot, (float)Math.PI, this.swimAmount);
//                this.bipedRightArm.yRot = Mth.lerp(f8, this.bipedRightArm.yRot, (float)Math.PI);
//                this.bipedLeftArm.zRot = this.rotlerpRad(this.bipedLeftArm.zRot, 5.012389F - 1.8707964F * f10, this.swimAmount);
//                this.bipedRightArm.zRot = Mth.lerp(f8, this.bipedRightArm.zRot, 1.2707963F + 1.8707964F * f10);
...
//                this.bipedRightArm.xRot = Mth.lerp(f8, this.bipedRightArm.xRot, ((float)Math.PI / 2F) - ((float)Math.PI / 2F) * f9);
//                this.bipedLeftArm.yRot = this.rotlerpRad(this.bipedLeftArm.yRot, (float)Math.PI, this.swimAmount);
//                this.bipedRightArm.yRot = Mth.lerp(f8, this.bipedRightArm.yRot, (float)Math.PI);
//                this.bipedLeftArm.zRot = this.rotlerpRad(this.bipedLeftArm.zRot, (float)Math.PI, this.swimAmount);
//                this.bipedRightArm.zRot = Mth.lerp(f8, this.bipedRightArm.zRot, (float)Math.PI);
//            }
//
//            float f11 = 0.3F;
//            float f12 = 0.33333334F;
//            this.bipedLeftLeg.xRot = Mth.lerp(this.swimAmount, this.bipedLeftLeg.xRot, 0.3F * Mth.cos(limbSwing * 0.33333334F + (float)Math.PI));
//            this.bipedRightLeg.xRot = Mth.lerp(this.swimAmount, this.bipedRightLeg.xRot, 0.3F * Mth.cos(limbSwing * 0.33333334F));
//        }
//
//        this.hat.copyFrom(this.bipedHead);
//
//        if (entity instanceof ArmorStand) {
//            setRotationAngles((ArmorStand) entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
//            return;
//        }
    }
...
//        return side == HumanoidArm.LEFT ? this.bipedLeftArm : this.bipedRightArm;
    ...
    private void setRotationAngles(ArmorStand entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
