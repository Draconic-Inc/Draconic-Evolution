...
public class ModelContributorWings extends Model {
    public RendererModel rightBaseStem;
    public RendererModel leftBaseStem;
    public RendererModel rightOuterStem;
    public RendererModel rightWingInner;
    public RendererModel rightWingOuter;
    public RendererModel leftOuterStem;
    public RendererModel leftWingInner;
    public RendererModel leftWingOuter;
    public PlayerRenderer renderPlayer = null;

    public ModelContributorWings() {
        this.textureWidth = 32;
        this.textureHeight = 32;
        this.leftWingOuter = new RendererModel(this, 0, 18);
...
//        this.leftWingOuter.addBox(-0.5F, 0.5F, 0.0F, 15, 14, 0, 0.0F);
        ...
        this.rightOuterStem = new RendererModel(this, 0, 2);
        ...
        this.leftWingInner = new RendererModel(this, 0, 4);
...
//        this.leftWingInner.addBox(-0.5F, 0.5F, 0.0F, 13, 14, 0, 0.0F);
        ...
        this.rightWingInner = new RendererModel(this, 0, 4);
...
//        this.rightWingInner.addBox(-12.5F, 0.5F, 0.0F, 13, 14, 0, 0.0F);
        ...
        this.rightWingOuter = new RendererModel(this, 0, 18);
...
//        this.rightWingOuter.addBox(-14.5F, 0.5F, 0.0F, 15, 14, 0, 0.0F);
        ...
        this.leftBaseStem = new RendererModel(this, 0, 0);
        ...
        this.leftOuterStem = new RendererModel(this, 0, 2);
        ...
        this.rightBaseStem = new RendererModel(this, 0, 0);
