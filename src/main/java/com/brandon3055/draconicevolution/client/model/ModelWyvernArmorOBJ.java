...
public class ModelWyvernArmorOBJ extends ModelBiped {
    ...
    public ModelWyvernArmorOBJ(float f, boolean isHelmet, boolean isChestPiece, boolean isLeggings, boolean isdBoots) {
