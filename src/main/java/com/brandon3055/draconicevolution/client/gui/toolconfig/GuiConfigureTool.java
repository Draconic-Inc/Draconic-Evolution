...
// */
//public class GuiConfigureTool extends Screen implements GuiPageButtonList.GuiResponder {//TODO add ability to rename config profiles
//
...
//
//    public GuiConfigureTool(GuiToolConfig parent, PlayerEntity player, ItemStack stack, PlayerSlot slot) {
//        this.parent = parent;
//        this.player = player;
//        this.stack = stack;
//        this.slot = slot;
