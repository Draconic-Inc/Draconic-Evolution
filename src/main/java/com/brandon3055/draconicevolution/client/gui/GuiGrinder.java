 ...
 */
public class GuiGrinder extends ContainerGuiProvider<ContainerBCTile<TileGrinder>> {

    @Override
    public void buildGui(ModularGui gui, ContainerScreenAccess<ContainerBCTile<TileGrinder>> screenAccess) {
...
//    }
    ...
    public static class Screen extends ModularGuiContainer<ContainerBCTile<TileGrinder>> {
        public Screen(ContainerBCTile<TileGrinder> menu, Inventory inv, Component title) {
