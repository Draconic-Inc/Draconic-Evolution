...
////                        drawModalRectWithCustomSizedTexture(xPos + 61, yPos + 21, 0, 319 + region.getFaceIO(Direction.DOWN) * 14, 14, 14, 512, 512);
////                        drawModalRectWithCustomSizedTexture(xPos + 61, yPos - 17, 14, 319 + region.getFaceIO(Direction.UP) * 14, 14, 14, 512, 512);
////                        drawModalRectWithCustomSizedTexture(xPos + 2, yPos - 17, 14, 319 + region.getFaceIO(Direction.SOUTH) * 14, 14, 14, 512, 512);
////                        drawModalRectWithCustomSizedTexture(xPos + 2, yPos + 21, 0, 319 + region.getFaceIO(Direction.NORTH) * 14, 14, 14, 512, 512);
////                        drawModalRectWithCustomSizedTexture(xPos + 21, yPos + 2, 28, 319 + region.getFaceIO(Direction.WEST) * 14, 14, 14, 512, 512);
////                        drawModalRectWithCustomSizedTexture(xPos - 17, yPos + 2, 42, 319 + region.getFaceIO(Direction.EAST) * 14, 14, 14, 512, 512);
////
...
////
////            Function<Direction, List<String>> ioTooltipGetter = facing -> {
////                List<String> list = new ArrayList<>();
////                int io = 0;
////                if (editingRegion >= 0) {
...
////                @Override
////                public List<String> getToolTip() {
////                    return ioTooltipGetter.apply(Direction.DOWN);
////                }
////            }));
////            //U
...
////                @Override
////                public List<String> getToolTip() {
////                    return ioTooltipGetter.apply(Direction.UP);
////                }
////            }));
////
////            //N
...
////                @Override
////                public List<String> getToolTip() {
////                    return ioTooltipGetter.apply(Direction.NORTH);
////                }
////            }));
////            //S
...
////                @Override
////                public List<String> getToolTip() {
////                    return ioTooltipGetter.apply(Direction.SOUTH);
////                }
////            }));
////            //W
...
////                @Override
////                public List<String> getToolTip() {
////                    return ioTooltipGetter.apply(Direction.WEST);
////                }
////            }));
////            //E
...
////                @Override
////                public List<String> getToolTip() {
////                    return ioTooltipGetter.apply(Direction.EAST);
////                }
////            }));
////
////            //F
...
////                    Direction facing = bID == 6 ? null : Direction.getFront(bID);
