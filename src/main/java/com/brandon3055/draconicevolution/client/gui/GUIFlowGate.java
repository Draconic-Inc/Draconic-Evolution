    ...
    public void drawScreen(int x, int y, float pt) {
        ...
        if (!tile.flowOverridden) {
            ...
            fontRendererObj.drawString(
                    ...
                    0xff0000);
            fontRendererObj.drawString(
                    flowRSHeigh, guiCrt - (fontRendererObj.getStringWidth(flowRSHeigh) / 2), guiTop + 31, 0x2c2c2c);
            fontRendererObj.drawString(
                    ...
                    0x660000);
            fontRendererObj.drawString(
                    flowRSLow, guiCrt - (fontRendererObj.getStringWidth(flowRSLow) / 2), guiTop + 61, 0x2c2c2c);
        } else
            drawCenteredString(
                    fontRendererObj,
