...
public class WikiConfig {
    ...
    //Windows
    public static int NAV_WINDOW = 0xFF3c3f41;
    public static int CONTENT_WINDOW = 0xFF3c3f41;
    public static int MENU_BAR = 0xFF3c3f41;

    //Text
    public static int NAV_TEXT = 0x00FFFF;
    public static int TEXT_COLOUR = 0x8c8c8c;

    public static String editTarget = "[CONFIG]";
            ...
            while (reader.hasNext()) {
                ...
                switch (name) {
                    ...
                    case "colourText2":
                        ...
                        break;
                    case "editMode":
                        GuiModWiki.editMode = reader.nextBoolean();
                        break;
                    case "editTarget":
                        editTarget = reader.nextString();
                        break;
                }
            }
    ...
    public static void save() {
        try {
            ...
            writer.name("editMode").value(GuiModWiki.editMode);
            writer.name("editTarget").value(editTarget);
