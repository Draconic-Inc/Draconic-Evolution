...
public class GuiTextureButton extends GuiButton {
    ...
    public GuiTextureButton(
            int id, int xPos, int yPos, int textureXPos, int textureYPos, int xSise, int ySise, String text) {
    ...
    public void drawButton(Minecraft mc, int x, int y) {
        if (this.visible) {
            ...
            this.drawTexturedModalRect(
                    this.xPosition, this.yPosition, textureXPos, textureYPos + k * height, this.width, this.height);
