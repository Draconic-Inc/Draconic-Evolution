...
//
//@OnlyIn(Dist.CLIENT)
//public class GuiDislocator extends Screen {
...
//
//    public GuiDislocator(PlayerEntity player) {
//        super();
//        this.player = player;
...
//        locations.clear();
//
//        CompoundNBT compound = teleporter.getTagCompound();
//        if (compound == null) {
//            return;
//        }
//        ListNBT list = compound.getTagList("Locations", 10);
//
//        for (int i = 0; i < list.tagCount(); i++) {
//            CompoundNBT tagLocation = list.getCompoundTagAt(i);
