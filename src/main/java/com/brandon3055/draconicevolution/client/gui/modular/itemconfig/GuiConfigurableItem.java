 ...
 */
public class GuiConfigurableItem extends ContainerGuiProvider<ContainerConfigurableItem> {

    @Override
    public void buildGui(ModularGui gui, ContainerScreenAccess<ContainerConfigurableItem> screenAccess) {
...
//
//        mainUI = GuiTexture.newDynamicTexture(() -> BCGuiTextures.getThemed("background_dynamic"));
