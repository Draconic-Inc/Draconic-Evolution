...
public class ParticleDistortion extends EntityFX {
    ...
    public ParticleDistortion(
            World par1World, double par2, double par4, double par6, float par8, float par9, float par10, float scale) {
    ...
    public ParticleDistortion(
        ...
        this.particleMaxAge =
                40 + world.rand.nextInt(40); // how soon the particle dies. You can use randomizer for this
