 ...
 */
public class ParticleEnergyRing extends EntityFX {
	/**
	...
	public ParticleEnergyRing(World world, double x, double y, double z, int maxAge, int flow, boolean advanced) {
	...
	public void update(int flow, boolean render)
	{
		...
		for (this.flow = 100; this.particleMaxAge - this.particleAge < 4; ++this.particleMaxAge) {}
	}
