...
public class EnergyParticle extends EntityFX {
	...
	public EnergyParticle(World world, double x, double y, double z, double tX, double tY, double tZ, int particle, boolean expand) {
	...
	public EnergyParticle(World world, double x, double y, double z, double tX, double tY, double tZ, int particle) {
