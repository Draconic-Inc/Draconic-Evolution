...
public class RenderDragon extends RenderLiving {
    ...
    private static final ResourceLocation enderDragonTextures =
            new ResourceLocation(References.RESOURCESPREFIX + "textures/entity/de_dragon.png");
    private static final ResourceLocation enderDragonTextures2 =
            new ResourceLocation(References.RESOURCESPREFIX + "textures/entity/de_chaos_dragon.png");
    /**
    ...
    protected void rotateCorpse(EntityDragon p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
        ...
        float f4 = (float)
                (p_77043_1_.getMovementOffsets(5, p_77043_4_)[1] - p_77043_1_.getMovementOffsets(10, p_77043_4_)[1]);
        ...
        if (dragon.healingEnderCrystal != null) {
            ...
            for (int i = 0; i <= b0; ++i) {
                ...
                tessellator.addVertexWithUV(
                        (double) (f11 * 0.2F), (double) (f12 * 0.2F), 0.0D, (double) f13, (double) f10);
            ...
            float f3 = MathHelper.sin(f2 * 0.2F) / 2.0F + 0.5F;
            f3 = (f3 * f3 + f3) * 0.2F;
            float f4 = (float) (((EntityChaosGuardian) dragon).crystalX
                    + 0.5
                    - dragon.posX
                    - (dragon.prevPosX - dragon.posX) * (double) (1.0F - p_76986_9_));
            float f5 = (float) ((double) f3
                    + ((EntityChaosGuardian) dragon).crystalY
                    + 0.5
                    - 1.0D
                    - dragon.posY
                    - (dragon.prevPosY - dragon.posY) * (double) (1.0F - p_76986_9_));
            float f6 = (float) (((EntityChaosGuardian) dragon).crystalZ
                    + 0.5
                    - dragon.posZ
                    - (dragon.prevPosZ - dragon.posZ) * (double) (1.0F - p_76986_9_));
            float f7 = MathHelper.sqrt_float(f4 * f4 + f6 * f6);
    ...
    protected void renderModel(
            ...
            float p_77036_7_) {
        this.renderModel(
                (EntityDragon) p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
    }
