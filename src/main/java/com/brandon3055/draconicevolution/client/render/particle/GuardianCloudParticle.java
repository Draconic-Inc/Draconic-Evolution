...
@OnlyIn(Dist.CLIENT)
public class GuardianCloudParticle extends SpriteTexturedParticle {
   private final IAnimatedSprite sprites;

   private GuardianCloudParticle(ClientWorld p_i232414_1_, double x, double y, double z, double mx, double my, double mz, IAnimatedSprite animatedSprite) {
