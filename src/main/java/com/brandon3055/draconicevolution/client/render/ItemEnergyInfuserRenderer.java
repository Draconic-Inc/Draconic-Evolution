...
public class ItemEnergyInfuserRenderer implements IItemRenderer
{
	TileEntitySpecialRenderer render;
	private TileEnergyInfuser dummytile;

	public ItemEnergyInfuserRenderer(TileEntitySpecialRenderer render, TileEnergyInfuser dummy) {
	    this.render = render;
