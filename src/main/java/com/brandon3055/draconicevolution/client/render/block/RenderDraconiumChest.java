...
public class RenderDraconiumChest implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		if (item.hasTagCompound() && item.getTagCompound().hasKey(ICustomItemData.tagName)) tile.readDataFromItem(item.getTagCompound().getCompoundTag(ICustomItemData.tagName), item);
