...
public class CustomParticle extends EntityFX
{
	...
	public CustomParticle(World world, double spawnX, double spawnY, double spawnZ, float spawnMotionX, float spawnMotionY, float spawnMotionZ, float scale, boolean canCollide, int index) {
