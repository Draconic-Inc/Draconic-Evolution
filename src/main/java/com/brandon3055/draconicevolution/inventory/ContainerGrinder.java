...
//
//    public ContainerGrinder(int windowId, PlayerInventory playerInv, PacketBuffer extraData, LayoutFactory<TileGrinder> layoutFactory) {
//        this(windowId, playerInv, getClientTile(extraData), layoutFactory);
//    }
//
//    public ContainerGrinder(int windowId, PlayerInventory player, TileGrinder tile, LayoutFactory<TileGrinder> layoutFactory) {
//        super(DEContent.container_grinder, windowId, player, tile, layoutFactory);
//    }
//
