...
//		helper.add(DEContent.crystal_wireless_chaotic,                          "Chaotic Wireless Energy Crystal");
		...
		add("tile." + DraconicEvolution.MODID + ".dislocation_inhibitor.info",  "Prevents items dropped within 5 blocks from being collected by Item Dislocators.");
...
//		add("gui.de.active.txt",                                                "Active");
	...
	private void hudAndMessages(PrefixHelper helper) {
		...
		add("hud." + DraconicEvolution.MODID + ".shield_hud.info",              "This HUD displays the current status or your Draconic Shield as well as your energy reserves and Undying modules.");
