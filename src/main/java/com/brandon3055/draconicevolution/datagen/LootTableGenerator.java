...
//        }
    ...
    public static class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
...
//            registerLootTable(DEContent.chaos_crystal, p_218546_0_ -> dropping(DEContent.chaos_shard, 5));
            ...
            //Fortune
            registerLootTable(DEContent.ore_draconium_overworld, (block) -> droppingWithSilkTouch(block, withExplosionDecay(block, ItemLootEntry.builder(DEContent.dust_draconium).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 4.0F))).acceptFunction(ApplyBonus.func_215869_a(Enchantments.FORTUNE)))));
            registerLootTable(DEContent.ore_draconium_nether, (block) -> droppingWithSilkTouch(block, withExplosionDecay(block, ItemLootEntry.builder(DEContent.dust_draconium).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 4.0F))).acceptFunction(ApplyBonus.func_215869_a(Enchantments.FORTUNE)))));
            registerLootTable(DEContent.ore_draconium_end, (block) -> droppingWithSilkTouch(block, withExplosionDecay(block, ItemLootEntry.builder(DEContent.dust_draconium).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 4.0F))).acceptFunction(ApplyBonus.func_215869_a(Enchantments.FORTUNE)))));
...
//            this.registerLootTable(Blocks.ACACIA_DOOR, (p_218483_0_) -> droppingWhen(p_218483_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER));
        ...
        protected static <T> T withExplosionDecay(IItemProvider p_218552_0_, ILootFunctionConsumer<T> p_218552_1_) {
            return (T)(!IMMUNE_TO_EXPLOSIONS.contains(p_218552_0_.asItem()) ? p_218552_1_.acceptFunction(ExplosionDecay.func_215863_b()) : p_218552_1_.cast());
        }
        ...
        protected static LootTable.Builder dropping(IItemProvider itemProvider, int count) {
            return LootTable.builder()
                    .addLootPool(withSurvivesExplosion(itemProvider, LootPool.builder()
                            .acceptFunction(SetCount.func_215932_a(ConstantRange.of(count)))
                            .addEntry(ItemLootEntry.builder(itemProvider))));
        }
        ...
        protected static LootTable.Builder droppingRandomly(IItemProvider p_218463_0_, IRandomRange p_218463_1_) {
            return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(withExplosionDecay(p_218463_0_, ItemLootEntry.builder(p_218463_0_).acceptFunction(SetCount.func_215932_a(p_218463_1_)))));
        }
        ...
        protected static LootTable.Builder droppingWithSilkTouchOrRandomly(Block p_218530_0_, IItemProvider p_218530_1_, IRandomRange p_218530_2_) {
            return droppingWithSilkTouch(p_218530_0_, withExplosionDecay(p_218530_0_, ItemLootEntry.builder(p_218530_1_).acceptFunction(SetCount.func_215932_a(p_218530_2_))));
        }
        ...
        protected static LootTable.Builder droppingSlab(Block p_218513_0_) {
            return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(withExplosionDecay(p_218513_0_, ItemLootEntry.builder(p_218513_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218513_0_).with(SlabBlock.TYPE, SlabType.DOUBLE))))));
        }
        ...
        protected static LootTable.Builder droppingWithName(Block p_218481_0_) {
            return LootTable.builder().addLootPool(withSurvivesExplosion(p_218481_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218481_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)))));
        }

        protected static LootTable.Builder droppingWithContents(Block p_218544_0_) {
            return LootTable.builder().addLootPool(withSurvivesExplosion(p_218544_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218544_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Lock", "BlockEntityTag.Lock").func_216056_a("LootTable", "BlockEntityTag.LootTable").func_216056_a("LootTableSeed", "BlockEntityTag.LootTableSeed")).acceptFunction(SetContents.func_215920_b().func_216075_a(DynamicLootEntry.func_216162_a(ShulkerBoxBlock.field_220169_b))))));
        }

        protected static LootTable.Builder droppingWithPatterns(Block p_218559_0_) {
            return LootTable.builder().addLootPool(withSurvivesExplosion(p_218559_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218559_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Patterns", "BlockEntityTag.Patterns")))));
        }
