...
//                return new Rectangle(gui.getGuiLeft() + 4, gui.getGuiTop() + 4, gui.getXSize() - 8, gui.getYSize() - 8);
//            }
//        });
//
...
//                return new Rectangle(gui.getGuiLeft() + gui.getXSize() - 30, gui.getGuiTop() + gui.getYSize() - 55, 25, 25);
//            }
//
//            @Override
//            public Rectangle getExpandedArea(GuiDraconiumChest gui) {
//                return new Rectangle(gui.getGuiLeft() + 5, gui.getGuiTop() + 5, gui.getXSize() - 10, 181);
//            }
//        });
