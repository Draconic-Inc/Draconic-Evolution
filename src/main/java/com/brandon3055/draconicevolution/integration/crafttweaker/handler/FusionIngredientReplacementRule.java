...
public final class FusionIngredientReplacementRule implements IReplacementRule {
    ...
    private <U extends IRecipe<?>> Optional<FusionRecipe.FusionIngredient> getIIngredientReplacement(final FusionRecipe.FusionIngredient original, final U recipe) {
