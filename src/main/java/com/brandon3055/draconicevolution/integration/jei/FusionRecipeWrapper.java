...
//                    effectRenderer.addEffect(new GuiFusionCraftingCore.EnergyEffect(Minecraft.getInstance().world, xPos, yPos, centerX, ty, 0));
//                }
//            }
//
//            double xPos = centerX - 8 + (world.rand.nextDouble() * 16);
//            double yTop = 35 - 8 + (world.rand.nextDouble() * 16);//35
//            effectRenderer.addEffect(new GuiFusionCraftingCore.EnergyEffect(Minecraft.getInstance().world, xPos, yTop, centerX, 78, 1));//78
//
//            effectRenderer.updateEffects();
//        }
//        else {
