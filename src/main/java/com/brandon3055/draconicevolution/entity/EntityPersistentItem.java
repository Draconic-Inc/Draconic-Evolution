 ...
 */
@Deprecated //TODO Vanilla entity may support this now
public class EntityPersistentItem extends ItemEntity {
...
//            setDead();
    ...
    public boolean isInRangeToRenderDist(double p_70112_1_) {
        double d1 = this.getBoundingBox().getAverageEdgeLength();
        d1 *= 64.0D * 4;
