...
//    private static final EntityDataAccessor<Optional<Holder<Module<?>>>> DAMAGE_MODIFIER = SynchedEntityData.defineId(DraconicProjectileEntity.class, EntityDataSerializer.forValueType(ByteBufCodecs.optional(Module.STREAM_CODEC)));
...
//        builder.define(ARROW_PROJECTILE, true);
//        builder.define(NO_DRAG, false);
//        builder.define(EFFECT_COLOR, -1);
////        builder.define(DAMAGE_MODIFIER, Optional.empty());
//    }
//
...
//    }
//
//    public void setDamageModifier(Holder<Module<?>> damageModule) {
//        if (damageModule != null && damageModule.value().getData() instanceof DamageModData) {
...
//        Optional<Holder<Module<?>>> opt = entityData.get(DAMAGE_MODIFIER);
//        if (opt.isPresent() && opt.get().value().getData() instanceof DamageModData) {
//            //noinspection unchecked
//            return (Module<DamageModData>) opt.get().value();
//        }
//        return null;
//    }
//
