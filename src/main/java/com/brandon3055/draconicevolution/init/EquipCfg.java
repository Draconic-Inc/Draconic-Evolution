...
public class EquipCfg {
    ...
    //@formatter:off
    //Default Values
    private static double DRACONIUM_HARVEST_SPEED   = 10D;
    private static double WYVERN_HARVEST_SPEED      = 15D;
    private static double DRACONIC_HARVEST_SPEED    = 25D;
    private static double CHAOTIC_HARVEST_SPEED     = 50D;
    ...
    private static double DRACONIUM_SWING_SPEED     = 1.125D;
    private static double WYVERN_SWING_SPEED        = 1.250D;
    private static double DRACONIC_SWING_SPEED      = 1.500D;
    private static double CHAOTIC_SWING_SPEED       = 2.000D;
    ...
    //These ratios are based on diamond tools
    private static double STAFF_SWING_SPEED_MULT          = 0.5D;
    private static double SWORD_SWING_SPEED_MULT          = 1.6D;
    private static double AXE_SWING_SPEED_MULT            = 1.0D;
    private static double PICKAXE_SWING_SPEED_MULT        = 1.2D;
    private static double SHOVEL_SWING_SPEED_MULT         = 1.0D;
    private static double HOE_SWING_SPEED_MULT            = 4.0D;
    ...
    public static void loadConfig(ConfigTag configTag) {
        ...
        equipTag.getTag("draconiumHarvestSpeed")
                .setComment("Internal Default Value: " + DRACONIUM_HARVEST_SPEED)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> draconiumHarvestSpeed = tag.getDouble() != -99 ? tag.getDouble() : DRACONIUM_HARVEST_SPEED);
        equipTag.getTag("wyvernHarvestSpeed")
                .setComment("Internal Default Value: " + WYVERN_HARVEST_SPEED)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> wyvernHarvestSpeed = tag.getDouble() != -99 ? tag.getDouble() : WYVERN_HARVEST_SPEED);
        equipTag.getTag("draconicHarvestSpeed")
                .setComment("Internal Default Value: " + DRACONIC_HARVEST_SPEED)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> draconicHarvestSpeed = tag.getDouble() != -99 ? tag.getDouble() : DRACONIC_HARVEST_SPEED);
        equipTag.getTag("chaoticHarvestSpeed")
                .setComment("Internal Default Value: " + CHAOTIC_HARVEST_SPEED)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> chaoticHarvestSpeed = tag.getDouble() != -99 ? tag.getDouble() : CHAOTIC_HARVEST_SPEED);
        ...
        equipTag.getTag("draconiumSwingSpeed")
                ...
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> draconiumSwingSpeed = tag.getDouble() != -99 ? tag.getDouble() : DRACONIUM_SWING_SPEED);
        equipTag.getTag("wyvernSwingSpeed")
                .setComment("Base Attack Speed (How many times you can attack at full power per second)\nInternal Default Value: " + WYVERN_SWING_SPEED)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> wyvernSwingSpeed = tag.getDouble() != -99 ? tag.getDouble() : WYVERN_SWING_SPEED);
        equipTag.getTag("draconicSwingSpeed")
                .setComment("Base Attack Speed (How many times you can attack at full power per second)\nInternal Default Value: " + DRACONIC_SWING_SPEED)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> draconicSwingSpeed = tag.getDouble() != -99 ? tag.getDouble() : DRACONIC_SWING_SPEED);
        equipTag.getTag("chaoticSwingSpeed")
                .setComment("Base Attack Speed (How many times you can attack at full power per second)\nInternal Default Value: " + CHAOTIC_SWING_SPEED)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> chaoticSwingSpeed = tag.getDouble() != -99 ? tag.getDouble() : CHAOTIC_SWING_SPEED);
        ...
        equipTag.getTag("staffSwingSpeedMultiplier")
                .setComment("This is a multiplier that is applied to the base attack speed\nInternal Default Value: " + STAFF_SWING_SPEED_MULT)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> staffSwingSpeedMultiplier = tag.getDouble() != -99 ? tag.getDouble() : STAFF_SWING_SPEED_MULT);
        equipTag.getTag("swordSwingSpeedMultiplier")
                .setComment("This is a multiplier that is applied to the base attack speed\nInternal Default Value: " + SWORD_SWING_SPEED_MULT)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> swordSwingSpeedMultiplier = tag.getDouble() != -99 ? tag.getDouble() : SWORD_SWING_SPEED_MULT);
        equipTag.getTag("axeSwingSpeedMultiplier")
                .setComment("This is a multiplier that is applied to the base attack speed\nInternal Default Value: " + AXE_SWING_SPEED_MULT)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> axeSwingSpeedMultiplier = tag.getDouble() != -99 ? tag.getDouble() : AXE_SWING_SPEED_MULT);
        equipTag.getTag("pickaxeSwingSpeedMultiplier")
                .setComment("This is a multiplier that is applied to the base attack speed\nInternal Default Value: " + PICKAXE_SWING_SPEED_MULT)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> pickaxeSwingSpeedMultiplier = tag.getDouble() != -99 ? tag.getDouble() : PICKAXE_SWING_SPEED_MULT);
        equipTag.getTag("shovelSwingSpeedMultiplier")
                .setComment("This is a multiplier that is applied to the base attack speed\nInternal Default Value: " + SHOVEL_SWING_SPEED_MULT)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> shovelSwingSpeedMultiplier = tag.getDouble() != -99 ? tag.getDouble() : SHOVEL_SWING_SPEED_MULT);
        equipTag.getTag("hoeSwingSpeedMultiplier")
                .setComment("This is a multiplier that is applied to the base attack speed\nInternal Default Value: " + HOE_SWING_SPEED_MULT)
                .setDefaultDouble(-99)
                .setSyncCallback((tag, type) -> hoeSwingSpeedMultiplier = tag.getDouble() != -99 ? tag.getDouble() : HOE_SWING_SPEED_MULT);
