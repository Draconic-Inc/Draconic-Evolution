...
//            }
//
//            CompoundNBT compound = ItemNBTHelper.getCompound(teleporter);
...
//                list.appendTag(tag);
//                compound.put("Locations", list);
//                teleporter.setTag(compound);
//            }
//
...
//                {
//                    if (selected > 0) {
//                        CompoundNBT temp = list.getCompoundTagAt(selected + selectionOffset);
