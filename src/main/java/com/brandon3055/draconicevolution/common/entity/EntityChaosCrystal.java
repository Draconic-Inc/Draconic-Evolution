...
public class EntityChaosCrystal extends EntityLivingBase {
	...
	public void onUpdate() {
		...
		if (health > 0){
			...
			if (this.worldObj.provider instanceof WorldProviderEnd && this.worldObj.getBlock(i, j, k).isBlockSolid(this.worldObj, i, j, k, 0) && this.worldObj.getBlock(i, j, k) != Blocks.fire) this.worldObj.setBlock(i, j, k, Blocks.fire);
