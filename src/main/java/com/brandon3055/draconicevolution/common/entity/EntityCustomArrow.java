...
public class EntityCustomArrow extends EntityArrow {
	...
	//Arrow Properties
	private double damageO = 2.0D; //old
	...
	public EntityCustomArrow(BowHandler.BowProperties bowProperties, World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_) {
		super(p_i1755_1_, p_i1755_2_, p_i1755_3_, p_i1755_4_, p_i1755_5_);
		this.bowProperties = bowProperties;
	}

	public EntityCustomArrow(BowHandler.BowProperties bowProperties, World par1World, EntityLivingBase par2EntityLivingBase, float velocity) {
			...
			if (movingobjectposition != null) {
				if (movingobjectposition.entityHit != null) {
					...
					if (!ignorSpeed) {
						...
						k = MathHelper.ceiling_double_int(f2 * this.damageO);
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		par1NBTTagCompound.setDouble("damageO", this.damageO);
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		if (par1NBTTagCompound.hasKey("damageO", 99)) {
			this.damageO = par1NBTTagCompound.getDouble("damageO");
		}
