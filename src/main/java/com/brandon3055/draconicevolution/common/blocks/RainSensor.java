...
public class RainSensor extends TolkienBlock
{
	IIcon icon_inactive;
	IIcon icon_active;
	IIcon icon_side;
	...
	public void randomDisplayTick(World world, int x, int y, int z, Random random)
	{
		...
		{
			if (rand == 0)
			world.spawnParticle("reddust", x + 1 - 0.155, y + 0.12, z + 1 - 0.155, 0.5, 0.4, 1);
			if (rand == 1)
			world.spawnParticle("reddust", x + 1 - 0.155, y + 0.12, z + 1 - 0.155, 1, 0.2, 0.2);
			if (rand == 1)
			world.spawnParticle("reddust", x + 1 - 0.155, y + 0.12, z + 0.155, 0.5, 0.4, 1);
			if (rand == 2)
			world.spawnParticle("reddust", x + 1 - 0.155, y + 0.12, z + 0.155, 1, 0.2, 0.2);
			if (rand == 2)
			world.spawnParticle("reddust", x + 0.155, y + 0.12, z + 1 - 0.155, 0.5, 0.4, 1);
			if (rand == 3)
			world.spawnParticle("reddust", x + 0.155, y + 0.12, z + 1 - 0.155, 1, 0.2, 0.2);
			if (rand == 3)
			world.spawnParticle("reddust", x + 0.155, y + 0.12, z + 0.155, 0.5, 0.4, 1);
			if (rand == 0)
			world.spawnParticle("reddust", x + 0.155, y + 0.12, z + 0.155, 1, 0.2, 0.2);
		}
	}
}
