...
public class CustomSpawner extends BlockDE implements IHudDisplayBlock {
    ...
    public boolean onBlockActivated(
            ...
            float p_149727_8_,
            float p_149727_9_) {
        TileCustomSpawner spawner =
                (world.getTileEntity(x, y, z) != null && world.getTileEntity(x, y, z) instanceof TileCustomSpawner)
        ...
        if (spawner != null) {
            ...
            if (item != null && item.getItem().equals(ModItems.mobSoul)) {
                ...
                return true;
                    ...
                    && item.getItem().equals(Items.nether_star)
                ...
                return true;
                    ...
                    && item.getItem().equals(ModItems.wyvernCore)
                ...
                return true;
                    ...
                    && item.getItem().equals(ModItems.awakenedCore)
                ...
                return true;
                    ...
                    && item.getItem().equals(Items.golden_apple)
                ...
                if (world.isRemote && !player.isSneaking()) {
                    ...
                    player.addChatMessage(new ChatComponentTranslation("msg.spawnerInfo1.txt")
                            .appendText(": " + EnumChatFormatting.DARK_AQUA + spawner.getBaseLogic().entityName));
                    player.addChatMessage(new ChatComponentTranslation("msg.spawnerInfo2.txt")
                            .appendText(": " + EnumChatFormatting.DARK_AQUA + spawner.getBaseLogic().requiresPlayer));
                    player.addChatMessage(new ChatComponentTranslation("msg.spawnerInfo3.txt")
                            .appendText(": " + EnumChatFormatting.DARK_AQUA
                                    + spawner.getBaseLogic().ignoreSpawnRequirements));
                    player.addChatMessage(new ChatComponentTranslation("msg.spawnerInfo4.txt")
                            .appendText(": " + EnumChatFormatting.DARK_AQUA + spawner.getBaseLogic().spawnSpeed));
    ...
    public void breakBlock(World world, int x, int y, int z, Block p_149749_5_, int p_149749_6_) {
        ...
        if (spawner != null && !world.isRemote) {
            ...
            if (spawner.getBaseLogic().ignoreSpawnRequirements) {
                EntityItem item =
                        new EntityItem(world, x + 0.5, y + 0.5, z + 0.5, new ItemStack(Items.golden_apple, 1, 1));
            ...
            if (spawner.getBaseLogic().spawnSpeed > 2) {
                EntityItem item =
                        new EntityItem(world, x + 0.5, y + 0.5, z + 0.5, new ItemStack(ModItems.awakenedCore));
                item.motionX = (-0.5F + world.rand.nextFloat()) * multiplyer;
                item.motionY = (4 + world.rand.nextFloat()) * multiplyer;
                item.motionZ = (-0.5F + world.rand.nextFloat()) * multiplyer;
                world.spawnEntityInWorld(item);
    ...
    public List<String> getDisplayData(World world, int x, int y, int z) {
        ...
        if (spawner != null) {
            ...
            if (world.isRemote && !Minecraft.getMinecraft().thePlayer.isSneaking()) {
                list.add(StatCollector.translateToLocal("msg.spawnerInfo1.txt") + ": " + EnumChatFormatting.DARK_AQUA
                        + spawner.getBaseLogic().entityName);
                list.add(StatCollector.translateToLocal("msg.spawnerInfo2.txt") + ": " + EnumChatFormatting.DARK_AQUA
                        + spawner.getBaseLogic().requiresPlayer);
                list.add(StatCollector.translateToLocal("msg.spawnerInfo3.txt") + ": " + EnumChatFormatting.DARK_AQUA
                        + spawner.getBaseLogic().ignoreSpawnRequirements);
                list.add(StatCollector.translateToLocal("msg.spawnerInfo4.txt") + ": " + EnumChatFormatting.DARK_AQUA
