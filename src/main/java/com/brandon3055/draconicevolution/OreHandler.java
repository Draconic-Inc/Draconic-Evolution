...
//            OreDictionary.registerOre("oreDraconium", new ItemStack(DEFeatures.draconiumOre, 1, 1));
//            OreDictionary.registerOre("oreDraconium", new ItemStack(DEFeatures.draconiumOre, 1, 2));
//        }
//
