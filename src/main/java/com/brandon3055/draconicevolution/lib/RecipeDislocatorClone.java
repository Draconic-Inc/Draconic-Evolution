...
//            CompoundNBT compound = new CompoundNBT();
//            location.writeToNBT(compound);
//            compound.putBoolean("IsSet", true);
//            output.setTag(compound);
//        }
//        else if (output.getItem() == DEFeatures.dislocatorAdvanced) {
//            CompoundNBT compound = ItemNBTHelper.getCompound(output);
//            ListNBT targetList = compound.getTagList("Locations", 10);
//
//            for (int i = 0; i < sourceList.tagCount(); i++) {
//                boolean matchFound = false;
//                TeleportLocation sourceLocation = new TeleportLocation();
//                CompoundNBT sourceCompound = sourceList.getCompoundTagAt(i);
...
//            }
//
//            compound.put("Locations", targetList);
//        }
//
//        return output;
//    }
